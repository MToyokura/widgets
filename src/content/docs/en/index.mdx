...
In the spirit of open education, this repository is in the [public domain (CC0 1.0)](https://creativecommons.org/publicdomain/zero/1.0/). You are more than welcome to fork it, build on it, and host your own version.
